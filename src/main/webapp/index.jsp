    ...
    <div id="carouselExampleCaptions" class="carousel slide">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="img/Home 1.jpg" class="d-block w-100" alt="..." height="600px">
            ...
            <div class="carousel-item">
                <img src="img/Home 2.jpg" class="d-block w-100" alt="..." height="600px">
                <div class="carousel-caption d-none d-md-block">
            ...
            <div class="carousel-item">
                <img src="img/Home 3.jpg" class="d-block w-100" alt="..." height="600px">
                <div class="carousel-caption d-none d-md-block">
